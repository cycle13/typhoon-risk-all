...
class Georgiou:
    ...
    def GeorgiouWindFieldModel(self,DeltaP0,VT0,Rmax0,Theta0,iL_ST0,iAlpha_ST0):
        ...
        V_SHBL_Spd, V_SHLB_Dir = shapiro.ShapiroWindFieldModel(DeltaP0,VT0,Rmax0,Theta0,iL_ST0,iAlpha_ST0) 
        
        # Shpiro在Rmax处平均风速(角度平均)
        Angle  = np.linspace(0,350,36)
        allV_SHBL_Spd_Rmax = []
        for i in range(len(Angle)): 
            iV_SHBL_Spd, Dir = shapiro.ShapiroWindFieldModel(DeltaP0,VT0,Rmax0,Theta0,Rmax0,Angle[i])
